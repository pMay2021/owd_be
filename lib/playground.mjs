...
owdMjs.log(owdMjs.getShortId(), "shortId");
owdMjs.log(owdMjs.getDayOfWeek("2030-10-08"), "daysOfWeek");
owdMjs.log(owdMjs.getNumberOfDaysBetweenDates("2025-06-19", "2023-10-20"), "numDays");
owdMjs.log(owdMjs.getFriendlyDateDifference("2023-06-19", "2025-10-25"), "friendly");
owdMjs.log(dbDocumentSchema, "Document Schema", false);
owdMjs.log(owdMjs.getOffsetDates("2030-10-08", [0, 60, 240]));
