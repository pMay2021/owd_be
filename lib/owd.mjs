...
const getVersion = () => {
  return {
    ...
    changes: "minor updates, getFriendlyDateDiff also gets total days diff"
  };
};
 ...
 */
const getShortId = (numberOfDigits = 15, customDigits = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-+/_") => {
