...
const getVersion = () => {
  return {
    ...
    changes:
      "now with basic dynamoDB get and put operations",
  };
};
...
export { getDayOfWeek, getShortId, getOffsetDates, getVersion, getNumberOfDaysBetweenDates, getFriendlyDateDifference, log, validateEmail, putItem, getItem, getItemByGSI};