...
const getVersion = () => {
  return {
    ...
    changes: "now with getCustomerByEmail query function",
  };
};
...
export { getVersion, putItem, getItem, queryItems, deleteItem, updateItem, getS3Text, getParameter, getCustomerByEmail };
